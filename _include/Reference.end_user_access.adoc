...
NOTE: If you're using Azure Virtual Desktop (classic) without Azure Resource Manager integration, connect to your resources at https://rdweb.AVD.microsoft.com/webclient instead.
