...
Comments Sections:
Used in: sub.Deploying.Azure.AVD.Deploying_AVD_in_Azure.adoc
...
. Click the Add button in the right hand side of the AVD host pools section header.
